 jQuery( function( $ ) {
    ...
    elementor.hooks.addAction( 'panel/open_editor/widget', function( panel, model, view ) {
        ...
        $('[data-setting="post_type"]').live('change', function () { //usage of 'live' because elements could be in non-opened section
        ...
        $('[data-setting="taxonomy_type"]').live('change', function () { //usage of 'live' because elements could be in non-opened section
